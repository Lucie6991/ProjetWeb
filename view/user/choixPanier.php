    ...
    if(empty($_SESSION["admin"])) {
        if ($quantity > 0) { ?>
            ...
            <div class='col-lg-3'>
                ...
                <input class="form-control" name="quantite" id="quantite" type="text" value="1" placeholder="1"
                       readonly>
                <div class='row'>
                    <br/>
            ...
            <div class='col-lg-2'>
                <button class='btn btn-dark' onclick="clic_plus();"><span class='glyphicon glyphicon-plus'></span>
                </button>
            </div> <?php
        }
